    ...
    <footer>
      <div className="app-container">
        <a
          ...
          className="rounded-2xl bg-gray-400 p-4"
        >
          <div>
            <svg
              height="48px"
      ...
      <div className="grid md:grid-flow-col ">
        <div className="space-y-10 mb-5 grid lg:grid-cols-3">
          <div>
          ...
          <div className="space-y-10 mt-5 md:mt-0">
            <div>
      ...
      <div className="grid grid-flow-row mt-10">
        <div className="flex justify-center space-x-5 mb-10">
          <a
            aria-label="DoorDash on Facebook"
            data-testid="FacebookSocialMediaButton"
            href="http://facebook.com/doordash"
          ...
          <a
            aria-label="DoorDash on Twitter"
            data-testid="TwitterSocialMediaButton"
            href="http://twitter.com/doordash"
            className="hover:scale-150"
          >
            <svg
              width="24"
          ...
          <a
            aria-label="DoorDash on Instagram"
            data-testid="InstagramSocialMediaButton"
            href="http://instagram.com/doordash"
            className="hover:scale-150"
          >
            <svg
              width="24"
        ...
        <div className="flex flex-wrap text-center sm:flex justify-center space-x-5">
          {/* <a aria-label="DoorDash Home Page" href="/">
            <div>
              <svg
                width="32"
                height="18"
          ...
          <a
            href="https://www.doordash.com/terms/?language=en-US"
            className="hover:italic hover:font-semibold"
          >
            Terms of Service
          </a>
          <a
            href="https://www.doordash.com/privacy/?language=en-US"
            className="hover:italic hover:font-semibold"
          >
            Privacy
          </a>
          <a
            href="https://help.doordash.com/consumers/s/privacy-policy-us?language=en-US#section-11"
            className="hover:italic hover:font-semibold"
          >
            Notice At Collection
          </a>
          <a
            href="https://www.doordash.com/food-delivery/?language=en-US"
            className="hover:italic hover:font-semibold"
          >
            Delivery Locations
          </a>
          <span>© 2022 DoorDash</span>
        </div>
      </div>
    </footer>
  );
